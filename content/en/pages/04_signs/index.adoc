...
image:./binary_system.svg[width="50%"]
...
image:./addition_extended.svg[width="50%"]
...
image:./one_and_two_complement.svg[width="100%"]
...
image:./fulladder_subtractor.svg[width="100%"]
