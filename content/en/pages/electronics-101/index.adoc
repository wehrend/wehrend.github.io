...
The second- important law in electrial engineering is the electrical power law, the multiplication of voltage and current
results in electrical power with the unit "Watt"


[role=“image”,“./electriacal_power_law.svg” ,imgfmt=“svg”]
\[ P[W] = U[V]\cdot I[A] \]

We will discuss this law in later post...
