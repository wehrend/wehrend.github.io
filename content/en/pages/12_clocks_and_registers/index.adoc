---
title: 12_Clocks_flipflops_and_registers
date: 2022-03-12
weight: 120
...
image:./rtl_scheme.svg[width="100%"]
...
|image:./crystal_symbol.svg[width="80%"]
|image:./inverter_chain_symbol.svg[width="80%"]
|typical frequence range: 1Mhz..100Mhz | typical frequence range: 1Hz..15Mhz(discrete layout)
|image:./pierce_gate_circuit.svg[width="350px"]
|image:./inverter_chain.svg[width="350px"]
...
image:./pierce_gate_circuit.svg[width="400px"]
...
image:./inverter_chain.svg[width="400px"]
...
|image:./flipflop_circuit.svg[width="80%"]
|image:./flipflop_symbol.svg[width="80%"]
|===
...
|image:./dflipflop_circuit.svg[width="80%"]
|image:./dflipflop_symbol.svg[width="80%"]
|===
