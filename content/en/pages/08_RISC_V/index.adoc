...
image:./cpu_structure.svg[width="120%"]
...
image:./cpu_structure_with_control.svg[width="120%"]
...
image:./cpu_instruction_part.svg[width="120%"]
...
image:./cpu_instruction_path.svg[width="120%"]
...
image:./cpu_data_path.svg[width="120%"]
