...
image:./inverter_symbol.svg[width=200]
...
image:./and_symbol.svg[width=200]
...
| associative law   | \[p \land (q \land r) = (p \land q) \land r = pqr\]      | \[p \lor (q \lor r) = (p \lor q) \lor r = p \lor q \lor r\]

| absorptions law   | \[p \land (p \lor q) = p\]                               | \[p \lor (p \land q) = p\]

| distributive law  | \[p \land (q \lor r) = (p \land q) \lor (p \land r) = pq \lor pr\]
                    | \[p \lor (q \land r) = (p \lor q) \land (p \lor r) = (p \lor q)(p \lor r)\]

| neutral elements  | \[p \land 1 = p\]                                        | \[p \lor 0 = p\]

| complement element| \[p \land \neg p = 0\]                                   | \[p \lor \neg p = 1\]

| *Reference*       | *Hans-Jochen Bartsch*                                    | *Taschenbuch Mathematischer Formeln, 20. Auflage, p. 27–28*
|====================================================================================================================
...
|======
| NAND | NOR
|image:./nand_symbol.svg[width=200] |image:./nor_symbol.svg[width=200]
|======
...
image:./de_morgan_nand_equivalence.svg[width=400]
...
image:./de_morgan_nor_equivalence.svg[width=400]
...
image:./common_symbols.svg[width=500]
...
|======
| wired and | wired or
|image:./wire_and.svg[width=250] | image:./wire_or.svg[width=250]
| # diodes: 2 | # diodes : 2
|======
...
image:./diode_structure.svg[width=450]

All we need to know right now is that a diode consist of one substrate (in most cases today silicon) which becomes n-dotted on one side and p-dotted on the other,
...
image:./mosfet_model.svg[width=500]
...
image:./inverter_nmos.svg[width=500]
...
image:./mosfet_symbols.svg[width=500]
...
image:./inverter_cmos.svg[width=500]
...
|======
| NMOS NAND | NMOS NOR
|image:./nand_nmos.svg[width=200] | image:./nor_nmos.svg[width=500]
...
|======
| CMOS NAND | CMOS NOR 
|image:./nand_cmos.svg[width=250] | image:./nor_cmos.svg[width=500]
