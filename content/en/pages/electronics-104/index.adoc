...
{{< hint info >}}
After this chapter you will know all the basics around linear components, integrated amplifiers and op-amps...
{{< /hint >}}
...
link:./differential_amp.asc[LTSpice file]

image:./differential_amp.png[width=700]
