...
There are a gazillion of appilications for either BJTs as switch as well as amplifier - in the following
...
Amother vital application, we already visited some time ago, is the application as a flip-flop
