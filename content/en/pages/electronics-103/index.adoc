...
The so-called astable multivibration in laymnen terms is a blinker circuit.
...
==== Two-Port-Theory and  h-parameters

The two-port-theory and the h-parameters are theoretical foundation for two-port-schematics.
It is utlized for example to describe amplifierrs, all circuits discusseed here have a common ground
in common.
