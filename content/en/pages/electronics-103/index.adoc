...
image:./astable_multivibrator_circuit.png[width="700px"]
...
a| emitter  Circuit
a| collector circuit
a| image:./transistor_base.webp[width="400px"]
a| image:./transistor_emitter.webp[width="400px"]
a| image:./transistor_collector.webp[width="400px"]
