...
a| RC coupling
a| direct coupling
a| image:./induction-coupling.svg[width="450px"]
a| image:./rc-coupling.svg[width="450px"]
a| image:./direct-coupling.svg[width="450px"]
|===
...
Today it is sseldom used for that reason.
However it has an advantage in selectign the right signals by resonance effects.
...
The advantag is that it allows for direct current ampplification; therefore it ist use in measurements and op-amp.
