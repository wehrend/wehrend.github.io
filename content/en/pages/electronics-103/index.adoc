...
the negative feedback results in a signal with less amplification but also a lowere distortion factor.
This is the big advantage of this principle.

image:./negative-feedback-circuit.svg[width="450px"]
