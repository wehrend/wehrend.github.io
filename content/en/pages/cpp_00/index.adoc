...
* **GCC (GNU Compiler Collection)** and its dependencies
* The **make** build tool
* Basic familiarity with the command line
* Some mathematical background (helpful for the audio and signal-processing parts)

Windows users can follow the course using <strong>Windows Subsystem for Linux **(WSL)**.
{{< /asciihint >}}
