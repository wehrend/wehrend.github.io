...
image:./memhierarchy.svg[width="100%"]
...
image:./ram_schematic.svg[width="90%"]
...
| image:./sram_nmos.svg[width="100%"]
| image:./dram.svg[width="100%"]
| transistor # 4 | transistor # 1 
|image:./sram_cmos.svg[width="100%"] |
| transistor # 6 |
|===
...
image:./register_file.svg[width="60%"]
...
image:./register_file_read_ports.svg[width="100%"]

image:./register_file_write_port.svg[width="100%"]
