...
image:./00_simpleLFO.png[Simple LFO schematic].

If you do not shy away from mathematical deep-dive explanations - (I sometimes do),
you can view the details https://www.electronics-tutorials.ws/opamp/opamp_6.html[here (intgrator)]
...
image:./01_SimpleLFO_simulation.png[Circuit Simulation]
