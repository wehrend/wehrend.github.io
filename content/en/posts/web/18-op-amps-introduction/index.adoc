...
image:./00_op-amp.svg[op-amp,width="400px"]
...
image:./01_op-amp-non-inverting.svg[non-inverting op-amp,width="400px"]
...
image:./02_voltage-follower.svg[voltage-follower,width="400px"]
...
image:./03_inverting_rectifier.png[inverting-rectifier,width="800px"]

image:./04_inverting_rectifier_signal.png[inverting-rectifier-signal,width="800px"]
