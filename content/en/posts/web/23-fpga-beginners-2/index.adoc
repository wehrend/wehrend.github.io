...
image:./00_quartus_create_symbol_files.png[Quartus - Symbol Files]
...
image:./01_quartus_symbol_tool.png[Quartus - Symbol Tool]
and you find the modules under directory project.

image:./02_quartus_library_window.png[Quartus - Library Window]

image:./03_quartus_counter_bdf_wo_pins.png[Quartus - Counter.bdf]

Next, follow the different buildsteps throughout the schematic file:

image:./04_quartus_counter_schematic_0.png[Quartus - Counter.bdf 0]

image:./05_quartus_counter_schematic_1.png[Quartus - Counter.bdf 1]

image:./06_quartus_counter_schematic_2.png[Quartus - Counter.bdf 2]

When under properties assigning the bus width, be aware that the syntax is '..' instead of ':' (semicolon) !!

image:./07_quartus_counter_schematic_3.png[Quartus - Counter.bdf 3]

image:./08_quartus_counter_schematic_4.png[Quartus - Counter.bdf 4]

image:./09_quartus_counter_schematic_5.png[Quartus - Counter.bdf 5]

image:./10_quartus_counter_schematic_6.png[Quartus - Counter.bdf 6]

image:./11_quartus_counter_schematic_7.png[Quartus - Counter.bdf 7]
...
image:./12_de0nano_clock.png[DE0-nano Clock]

And the picture of the LED outputs.

image:./13_de0nano_output.png[DE0-nano Output]
...
image:./15_quartus_pin_planner_counter.png[Quartus - Pin Planner counter]
...
image:./14_quartus_programmer_counter.png[Quartus - Programmer Counter]
