...
image:./01_quartus_project_introduction.png[Quartus - New Project Wizard]
...
image:./04_quartus_choose_device.png[Quartus - Choose Device]
...
image:./05_quartus_project_summary.png[Quartus - Project Summary]
...
image:./11_quartus_pin_tool.png[Quartus - Pin tool]
...
image:./12_quartus_link_output.png[Quartus - Link output]

Now, lets do the same thing equivalent for the input pins...

image:./13_quartus_logic_circuit.png[Quartus - Logic circuit]
...
image:./19_quartus_pin_planner_pins_assigned.png[Quartus - Pin Planner - pins assigned]
...
image:./20_quartus_pins_assigned.png[Quartus - Pins assigned]
...
image:./21_quartus_synthesis.png[Quartus - Synthesis]
...
image:./22_quartus_programmer.png[Quartus - Programmer]
...
image:./23_quartus_programmer_sof.png[Quartus - Programmer SOF]
...
image:./24_quartus_circuit_extended.png[Quartus - Extended Circuit]
...
image:./25_quartus_pin_planner_ii.png[Quartus - Pin Planner II]
