...
image:./00_quartus_menu_new_project.png[Quartus - New Project Wizard]
...
image:./05_quartus_project_summary.png[Quartus - Projektzusammenfassung]
...
image:./10_quartus_and_gate_0.png[Quartus - Und-Gatter 0]
...
image:./11_quartus_pin_tool.png[Quartus - Pin-Werkzeug]
...
image:./12_quartus_link_output.png[Quartus - Verbindung der Ausgabe]

Jetzt machen wir dasselbe für die Eingangspins...

image:./13_quartus_logic_circuit.png[Quartus - Logikschaltung]
...
image:./14_quartus_logic_circuit_ii.png[Quartus - Logic circuit II]
...
image:./15_de0nano_input.png[Quartus - DE0-nano input]
...
image:./16_de0nano_output.png[Quartus - DE0-nano output]
...
image:./17_quartus_analysis_and_elaboration.png[Quartus - Analysis & Elaboration]
...
image:./18_quartus_pin_planner_after_run.png[Quartus - Pin Planner]
...
image:./20_quartus_pin_planner_pins_assigned.png[Quartus - Pin Planner - Pins zugewiesen]
...
image:./21_quartus_pins_assigned.png[Quartus - Pins zugewiesen]
...
image:./22_quartus_synthesis.png[Quartus - Synthesis]
...
image:./23_quartus_programmer.png[Quartus - Programmer]
...
image:./24_quartus_programmer_sof.png[Quartus - Programmer SOF]
...
image:./25_quartus_circuit_extended.png[Quartus - Erweiterter Schaltkreis]
...
image:./26_quartus_pin_planner_ii.png[Quartus - Pin Planner II]
