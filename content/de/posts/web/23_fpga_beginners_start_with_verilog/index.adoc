...
iamge:./quartus_counter_schematic_4.png[Quartus - Counter.bdf 4]
...
image:./14_quartus_pin_planner_counter.png[Quartus - Pin Planner counter]
...
image:./15_quartus_programmer_counter.png[Quartus - Programmer Counter]
