...
image::./00_op-amp.svg[op-amp, width=33%]
...
image::./01_op-amp-non-inverting.svg[non-inverting op-amp, width=33%]
...
image::./02_voltage-follower.svg[voltage-follower, width=33%]
