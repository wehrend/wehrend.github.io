...
image:./00_de0nano.jpg[DE-0 nano]
...
image:./01_quartus_installer_selection.png[Quartus-Installationsprogramm]
...
image:./02_quartus_ide.png[Quartus IDE]
...
image:./03_my_first_fpga_view.png[Erstes FPGA]
...
image:./04_my_first_fpga_bdf.png[Erste FPGA-Block-Design-Datei]
...
image:./05_quartus_pin_assignment.png[Quartus Pin Assignment]
...
image:./06_quartus_compile_report.png[Quartus Compile Report]
...
image:./07_modelsim.png[Modelsim]
