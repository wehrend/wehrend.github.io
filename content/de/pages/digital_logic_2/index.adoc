...
_link:./docs/digital_logic_2/10_sequential_logic[Einführung in sequentielle Logik]_
...
_link:./docs/digital_logic_2/11_clocks_and_registers/[Uhren, Flipflops und Register]_
...
_link:./docs/digital_logic_2/12_automata/[Automaten]_
...
_link:./docs/digital_logic_02/13_cpu_control/[CPU-Steuerung]_
...
_link:./docs/digital_logic_02/14_programmable_logic/[Programmierbare Logik]_

Wir stellen das Konzept der programmierbaren Logik sowohl für kombinatorische als auch sequentielle Logik vor.

== *Gründlich testen*

_link:./docs/digital_logic_02/15_testable_logic/[Testable Logic]_
