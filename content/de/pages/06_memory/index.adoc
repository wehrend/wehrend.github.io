...
image:./memhierarchy.svg[width=700]
...
image:./ram_schematic.svg[width=500]
...
| image:./sram_nmos.svg[width=350]
| image:./dram.svg[width=350]
| Transistor Nr. 4 | Transistor Nr. 1
| image:./sram_cmos.svg[width=350] |
| Transistor Nr. 6 |
|===
...
image:./register_file.svg[width=300]
...
image:./register_file_read_ports.svg[width=450]

image:./register_file_write_port.svg[width=450]
