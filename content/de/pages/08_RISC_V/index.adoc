...
image:./instruction_types.png[width=„140%“]
...
image:./cpu_structure_with_control.svg[width=600]
...
image:./cpu_instruction_part.svg[width=500]
...
image:./cpu_instruction_path.svg[width=500]
...
image:./cpu_data_path.svg[width=600]
