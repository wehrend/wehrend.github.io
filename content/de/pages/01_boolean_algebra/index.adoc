...
| Assoziativgesetz       | \[p \land (q \land r) = (p \land q) \land r = pqr\]        | \[p \lor (q \lor r) = (p \lor q) \lor r = p \lor q \lor r\]

| Absorptionsgesetz      | \[p \land (p \lor q) = p\]                                | \[p \lor (p \land q) = p\]

| Distributivgesetz      | \[p \land (q \lor r) = (p \land q) \lor (p \land r) = pq \lor pr\]
                         | \[p \lor (q \land r) = (p \lor q) \land (p \lor r) = (p \lor q)(p \lor r)\]

| Neutrale Elemente      | \[p \land 1 = p\]                                         | \[p \lor 0 = p\]

| Komplementgesetz       | \[p \land \neg p = 0\]                                    | \[p \lor \neg p = 1\]

| *Referenz*             | *Hans-Jochen Bartsch*                                     | *Taschenbuch mathematischer Formeln, 20. Auflage, S. 27–28*
|====================================================================================================================
