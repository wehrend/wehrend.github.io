...
_link:/de/pages/10_sequential_logic[Einführung in sequentielle Logik]_
...
_link:/de/pages/11_clocks_and_registers/[Uhren, Flipflops und Register]_
...
_link:/de/pages/12_automata/[Automaten]_
...
_link:/de/pages/13_cpu_control/[CPU-Steuerung]_
...
_link:/de/pages/14_programmable_logic/[Programmierbare Logik]_

Wir stellen das Konzept der programmierbaren Logik sowohl für kombinatorische als auch sequentielle Logik vor.

== *Gründlich testen*

_link:/dev/pages/15_testable_logic/[Testable Logic]_
