...
image:./binary_system.svg[width=300]
...
image:./addition_extended.svg[width=300]
...
image:./one_and_two_complement.svg[width=500]
...
image:./fulladder_subtractor.svg[width=600]
